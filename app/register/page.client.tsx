...
import { LuMessageSquarePlus, LuLanguages, LuVideo, LuFiles, LuHistory, LuUser, LuPanelLeftClose, LuPanelLeftOpen } from "react-icons/lu";
    ...
    <div className={styles.container}>
      ...
      <aside className={`${styles.sidebar} ${isSidebarCollapsed ? styles.collapsed : ''}`}>
        <div className={styles.header}>
           <div className={styles.logo} onClick={toggleSidebar}></div>
           {!isSidebarCollapsed && (
        ...
        <nav className={styles.nav}>
          ...
          <a href="#" className={styles.navItem} title="Translate Text">
            <Icons.Translate />
            {!isSidebarCollapsed && <span>Translate Text</span>}
          </a>
          <a href="#" className={styles.navItem} title="Translate Video">
            <Icons.Video />
            {!isSidebarCollapsed && <span>Translate Video</span>}
          </a>
        ...
        <div className={styles.userProfile}>
          ...
          {!isSidebarCollapsed && <span className={styles.userName}>Aahad Aazar</span>}
        </div>
      </aside>
